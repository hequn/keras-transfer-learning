...
from keras.applications.mobilenet import MobileNet  as KerasMobileV1
...
class MobileV1(BaseModel):
    ...
    def __init__(self, *args, **kwargs):
        super(MobileV1, self).__init__(*args, **kwargs)
    ...
    def _create(self):
        base_model = KerasMobileV1(weights='imagenet', include_top=False, input_tensor=self.get_input_tensor())
        ...
        embedding = Dense(self.noveltyDetectionLayerSize, activation='relu', name=self.noveltyDetectionLayerName)(x)
